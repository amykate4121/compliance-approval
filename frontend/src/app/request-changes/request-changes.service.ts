...
export class RequestChangesService {
  ...
  sendRequest(e, container) {
    ...
    this.container.documentEditor.editor.enforceProtection('credential', 'NoProtection');
    (container as DocumentEditorContainerComponent ).documentEditor.save('Commented Report For Changes', 'Sfdt')
